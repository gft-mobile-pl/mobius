...
open class DefaultIconButtonStyle : IconButtonStyle {
    override val size = TokenReference { Mobius.styles.buttonStyle.height }
    ...
    override val disabledBackgroundColor = Token(Color.Unspecified)
...
open class FilledIconButtonStyle : IconButtonStyle {
    override val size = TokenReference { Mobius.styles.buttonStyle.height }
    override val iconSize = Token { IconSize.Medium }
    override val backgroundColor = Token { Mobius.colors.primary }
    override val contentColor = Token { Mobius.colors.onPrimary }
    override val border: Token<BorderStroke?> = Token(null)
    override val disabledBackgroundColor = Token { Mobius.colors.onSurface.copy(alpha = 0.12f) }
    override val disabledContentColor = Token { Mobius.colors.onSurface.copy(alpha = 0.38f) }
    override val disabledBorder: Token<BorderStroke?> = Token(null)
    override val shape: Token<Shape> = Token(CircleShape)
}
...
open class FilledTonalIconButtonStyle : IconButtonStyle {
    override val size = TokenReference { Mobius.styles.buttonStyle.height }
    override val iconSize = Token { IconSize.Medium }
    override val backgroundColor = Token { Mobius.colors.secondaryContainer }
...
open class OutlinedIconButtonStyle : IconButtonStyle {
    ...
    override val disabledBackgroundColor = Token(Color.Transparent)
    override val disabledContentColor = Token { Mobius.colors.onSurface.copy(alpha = 0.38f) }
