...
open class DefaultDateRangePickerStyle : DateRangePickerStyle {
    ...
    override val headlineTextStyle = Token { Mobius.typography.titleLarge }
    override val weekdayContentColor = Token { Mobius.colors.onSurface }
    override val subheadContentColor = Token { Mobius.colors.onSurfaceVariant }
    ...
    override val dayInSelectionRangeContentColor = Token { Mobius.colors.onSecondaryContainer }
    override val dayInSelectionRangeContainerColor = Token { Mobius.colors.secondaryContainer }
