...
fun RangeSlider(
    ...
    startTooltipVisibility: Slider.TooltipVisibility = Slider.TooltipVisibility.VisibleOnInteraction(),
    endTooltipVisibility: Slider.TooltipVisibility = Slider.TooltipVisibility.VisibleOnInteraction(),
...
fun RangeSlider(
    ...
    startThumb: @Composable (RangeSliderState, MutableInteractionSource) -> Unit = { state, interactionSource ->
        SliderThumb(
            tooltip = Slider.TooltipVisibility.VisibleOnInteraction().formatter(state.activeRangeStart),
            enabled = enabled,
    ...
    endThumb: @Composable (RangeSliderState, MutableInteractionSource) -> Unit = { state, interactionSource ->
        SliderThumb(
            tooltip = Slider.TooltipVisibility.VisibleOnInteraction().formatter(state.activeRangeEnd),
            enabled = enabled,
            interactionSource = interactionSource
        )
    },
