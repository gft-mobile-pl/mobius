...
private fun LocalDate.toUTCMillis() = atStartOfDay(ZoneOffset.UTC.normalized()).toInstant().toEpochMilli()

private fun Long.toLocalDate() = Instant.ofEpochMilli(this).atZone(ZoneOffset.UTC.normalized()).toLocalDate()
