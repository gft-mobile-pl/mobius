...
interface CardStyleValues : StyleValues {
...
@Composable
fun CardStyle.resolve() = produceStyleValues { style ->
    object : CardStyleValues {
        ...
        override val draggedElevation = style.draggedElevation.resolve()
