...
interface ContentElementSpacerStyleValues : StyleValues {
...
interface ContentElementSpacerStyle : Style {
...
@Composable
fun ContentElementSpacerStyle.resolve() = produceStyleValues { style ->
    object : ContentElementSpacerStyleValues {
...
open class DefaultContentElementSpacerStyle : ContentElementSpacerStyle {
