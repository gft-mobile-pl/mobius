...
fun Slider(
    ...
    tooltipVisibility: Slider.TooltipVisibility = Slider.TooltipVisibility.Default,
...
fun Slider(
    ...
    thumb: @Composable (SliderState, MutableInteractionSource) -> Unit = { sliderState, interactionSource ->
        SliderThumb(
            tooltip = Slider.TooltipVisibility.Default.formatter(sliderState.value),
            enabled = enabled,
            interactionSource = interactionSource
        )
    },
...
interface Slider {
    ...
    sealed interface TooltipVisibility {
        ...
        data class VisibleOnInteraction(val formatter: (Float) -> String) : TooltipVisibility

        companion object {
            val Default = VisibleOnInteraction(DefaultSliderTooltipFormatter)
        }
    }
}
...
internal expect val DefaultSliderTooltipFormatter: (Float) -> String
