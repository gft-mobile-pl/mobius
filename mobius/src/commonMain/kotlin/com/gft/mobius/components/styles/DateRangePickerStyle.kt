...
interface DateRangePickerStyleValues : StyleValues {
...
interface DateRangePickerStyle : Style {
    ...
    val subheadContentColor: Token<Color>
    ...
    val dayInSelectionRangeContentColor: Token<Color>
    val dayInSelectionRangeContainerColor: Token<Color>
...
@Composable
fun DateRangePickerStyle.resolve() = produceStyleValues(
    StyleValuesProducer<DateRangePickerStyle, DateRangePickerStyleValues> { style: DateRangePickerStyle ->
    object : DateRangePickerStyleValues {
        ...
        override val subheadContentColor = style.subheadContentColor.resolve()
        ...
        override val dayInSelectionRangeContentColor = style.dayInSelectionRangeContentColor.resolve()
        override val dayInSelectionRangeContainerColor = style.dayInSelectionRangeContainerColor.resolve()
...
open class DefaultDateRangePickerStyle : DateRangePickerStyle {
    ...
    override val headlineTextStyle: Token<TextStyle> = Token { Mobius.typography.titleLarge }
    override val weekdayContentColor: Token<Color> = Token { Mobius.colors.onSurface }
    override val subheadContentColor: Token<Color> = Token { Mobius.colors.onSurfaceVariant }
    ...
    override val dayInSelectionRangeContentColor: Token<Color> = Token { Mobius.colors.onSecondaryContainer }
    override val dayInSelectionRangeContainerColor: Token<Color> = Token { Mobius.colors.secondaryContainer }
